...
public class Custom_Adapter_Artists extends SimpleCursorAdapter {
	...
	public Custom_Adapter_Artists(Context context,int layout, Cursor c,String[] from,int[] to) {
...
//-------------------------------------------------------------------------------------------			
		 if(cursor.getPosition()==Artists.ArtistPosition){
			if(Artists.isArtistPaused==1){
			...
			else if(Artists.isArtistPaused==0){
