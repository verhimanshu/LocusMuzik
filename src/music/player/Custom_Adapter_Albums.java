...
public class Custom_Adapter_Albums extends SimpleCursorAdapter {
	...
	public Custom_Adapter_Albums(Context context,int layout, Cursor c,String[] from,int[] to) {
...
//-------------------------------------------------------------------------------------------			
		 if(cursor.getPosition()==Albums.AlbumPosition){
			if(Albums.isAlbumPaused==1){
			...
			else if(Albums.isAlbumPaused==0){
