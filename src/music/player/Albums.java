...
public class Albums extends ListActivity implements AudioManager.OnAudioFocusChangeListener{
     ...
     public static int AlbumPosition=-5;
     int ResumePosition=0;
     public static int isAlbumPaused=-1;  //true=0 false=1 notInsideActivity=-1
     MediaPlayer mMediaPlayer=MainActivity.mPlayer;
     String filename;
   //  ListAdapter adapter;
     int RememberAlbumPosition;
     int count,index,top;
     ListView lv;
     View v;
     AudioManager am; 
     int result;
     Custom_Adapter_Albums adapter12;
...
//----------------------------------------------------------------------------------------------	
		String sortOrder = MediaStore.Audio.Media.ALBUM + " ASC"; //----->Use for artists
		...
		//    adapter = new SimpleCursorAdapter(this,R.layout.music_items, musiccursor, new String[]{MediaStore.Audio.Media.TITLE,MediaStore.Audio.Media.ARTIST} ,a);
		   adapter12=new Custom_Adapter_Albums(this, R.layout.music_items, musiccursor, new String[]{MediaStore.Audio.Media.TITLE, MediaStore.Audio.Media.ARTIST},a);
		    ...
		    mMediaPlayer.setOnCompletionListener(new OnCompletionListener() {
				...
				public void onCompletion(MediaPlayer mp) {
					...
					try {
						if(AlbumPosition<=musiccursor.getCount()-2){
						mMediaPlayer.reset();
						AlbumPosition=AlbumPosition+1;
						playSong(AlbumPosition);
	...
	protected void onResume() {
		...
		if(isAlbumPaused==0){
			...
			AlbumPosition=RememberAlbumPosition;
			adapter12.notifyDataSetChanged();
		}
	}
	...
	@Override
		...
		if(result!=AudioManager.AUDIOFOCUS_REQUEST_GRANTED){
			Toast.makeText(getApplicationContext(), "Request not Granted", Toast.LENGTH_LONG).show();
				  ...
				  //Resume Song
				  if(ResumePosition>0 && AlbumPosition==position)
				  {
				  	...
				  	if(mMediaPlayer.isPlaying())
				  	{
				  		...
				  		else
				  		{
				  			...
				  			//If different song is selected	
					  			...
					  			ResumePosition=0;
					  			RememberAlbumPosition=AlbumPosition;
					  			isAlbumPaused=1;
					  			try {
									playSong(position);
								} 
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_settings:
			Intent myIntent =new Intent(Albums.this,HomeScreen.class);
